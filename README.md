...
## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,295 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 3,017 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-14

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 506,295 | 🐛 106 | 📅 2026-09-02.
...
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 44,001 | 🐛 564 | 🌐 Scala | 📅 2026-09-15 <sub>![Scala/Java/Python/R][language-scala-java-python-r]</sub> - Scalable, fault-tolerant stream processing on Apache Spark.
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 33,730 | 🐛 562 | 🌐 Java | 📅 2026-09-15 <sub>![Java/Scala][language-java-scala]</sub> - Distributed event streaming platform for high-performance data pipelines and applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,336 | 🐛 370 | 🌐 Java | 📅 2026-09-15 <sub>![Java][language-java]</sub> - Distributed engine for stateful computation over bounded and unbounded data streams.
* [NSQ](https://github.com/nsqio/nsq) ⭐ 25,777 | 🐛 78 | 🌐 Go | 📅 2026-08-11 <sub>![Go][language-go]</sub> - Real-time distributed messaging platform designed to operate at scale.
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,598 | 🐛 691 | 🌐 Java | 📅 2026-09-15 <sub>![Java][language-java]</sub> - Cloud-native messaging and streaming platform for event-driven applications.
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,331 | 🐛 1,734 | 🌐 Java | 📅 2026-09-15 <sub>![Java][language-java]</sub> - Distributed pub-sub messaging and event streaming platform.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 12,547 | 🐛 524 | 🌐 C++ | 📅 2026-08-22 <sub>![C++][language-cpp]</sub> - Kafka API-compatible streaming data platform without ZooKeeper or a JVM.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 10,754 | 🐛 60 | 🌐 Java | 📅 2026-09-14 <sub>![Java/Scala][language-java-scala]</sub> - Diskless Kafka-compatible streaming platform that stores durable data in object storage.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 9,326 | 🐛 1,680 | 🌐 Rust | 📅 2026-09-15 <sub>![Rust][language-rust]</sub> - PostgreSQL-compatible streaming database for event-driven applications, real-time ETL, and continuous analytics.
* [Aeron](https://github.com/aeron-io/aeron) ⭐ 8,865 | 🐛 23 | 🌐 Java | 📅 2026-09-15 <sub>![Java/C++][language-java-cpp]</sub> - Reliable UDP unicast, multicast, and IPC message transport.
* [Apache Storm](https://github.com/apache/storm) ⭐ 6,694 | 🐛 33 | 🌐 Java | 📅 2026-09-15 <sub>![Java][language-java]</sub> - Distributed real-time computation system for reliably processing unbounded streams of data.
* [Fluvio](https://github.com/fluvio-community/fluvio) ⭐ 5,255 | 🐛 139 | 🌐 Rust | 📅 2026-08-30 <sub>![Rust/WASM][language-rust-wasm]</sub> - Composable, stateful data streaming system with programmable in-line computation.
* [Arroyo](https://github.com/ArroyoSystems/arroyo) ⭐ 5,033 | 🐛 123 | 🌐 Rust | 📅 2026-09-14 <sub>![Rust][language-rust]</sub> - Distributed stream processing engine for stateful SQL computations over unbounded data.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,830 | 🐛 284 | 🌐 Rust | 📅 2026-09-15 <sub>![Rust/Go/TypeScript][language-rust-go-typescript]</sub> - Kubernetes-native, language-agnostic platform for scalable event-driven applications.
* [PipelineDB](https://github.com/pipelinedb/pipelinedb) ⭐ 2,663 | 🐛 133 | 🌐 C | 📅 2022-02-20 <sub>![Archived][archived-badge]</sub> <sub>![C][language-c]</sub> - Unmaintained PostgreSQL extension for continuous SQL aggregation over time-series data.
...
* [Proton](https://github.com/timeplus-io/proton) ⭐ 2,260 | 🐛 77 | 🌐 C++ | 📅 2026-09-10 <sub>![C++][language-cpp]</sub> - Unified streaming and historical data analytics database powered by ClickHouse.
* [Bytewax](https://github.com/bytewax/bytewax) ⭐ 2,050 | 🐛 38 | 🌐 Python | 📅 2026-06-20 <sub>![Python/Rust][language-python-rust]</sub> - Community-maintained Python framework with a Rust-based distributed engine for stateful stream processing.
...
* [eKuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,735 | 🐛 52 | 🌐 Go | 📅 2026-09-15 <sub>![Go][language-go]</sub> - Lightweight data stream processing engine for resource-constrained IoT edge devices.
* [Siddhi](https://github.com/siddhi-io/siddhi) ⭐ 1,593 | 🐛 125 | 🌐 Java | 📅 2026-05-05 <sub>![Java][language-java]</sub> - Streaming SQL and complex event processing engine.
* [Wally](https://github.com/WallarooLabs/wally) ⭐ 1,482 | 🐛 351 | 🌐 Pony | 📅 2026-09-03 <sub>![Archived][archived-badge]</sub> <sub>![Pony][language-pony]</sub> - Distributed stream processing framework formerly named Wallaroo.
* [Mantis](https://github.com/Netflix/mantis) ⭐ 1,471 | 🐛 93 | 🌐 Java | 📅 2026-09-11 <sub>![Java][language-java]</sub> - Netflix platform for building real-time, operations-focused stream processing applications.
...
* [ArkFlow](https://github.com/arkflow-rs/arkflow) ⭐ 1,304 | 🐛 32 | 🌐 Rust | 📅 2026-09-15 <sub>![Rust][language-rust]</sub> - High-performance stream processing engine with pluggable sources, processors, and sinks.
* [Trill](https://github.com/microsoft/Trill) ⭐ 1,270 | 🐛 50 | 🌐 C# | 📅 2024-01-08 <sub>![Archived][archived-badge]</sub> <sub>![C#][language-csharp]</sub> - Single-node query processor for temporal and streaming data from Microsoft Research.
...
* [Apache Samza](https://github.com/apache/samza) ⭐ 846 | 🐛 45 | 🌐 Java | 📅 2026-09-01 <sub>![Java/Scala][language-java-scala]</sub> - Distributed stream processing framework built on Apache Kafka with standalone and YARN deployment options.
* [Gazette](https://github.com/gazette/core) ⭐ 797 | 🐛 20 | 🌐 Go | 📅 2026-09-09 <sub>![Go][language-go]</sub> - Cloud-storage-backed streaming infrastructure that combines SQL, batch, and millisecond-latency stream processing.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 797 | 🐛 49 | 🌐 Go | 📅 2026-09-15 <sub>![Go/Python][language-go-python]</sub> - Stream processing engine that runs DuckDB SQL over Kafka, WebSocket, and webhook streams.
* [Gearpump](https://github.com/gearpump/gearpump) ⭐ 755 | 🐛 4 | 🌐 Scala | 📅 2026-09-12 <sub>![Scala][language-scala]</sub> - Lightweight real-time distributed streaming engine built on Akka.
* [Apache StreamPipes](https://github.com/apache/streampipes) ⭐ 750 | 🐛 55 | 🌐 Java | 📅 2026-09-15 <sub>![Java/Python/TypeScript][language-java-python-typescript]</sub> - Self-service industrial IoT platform for connecting, analyzing, and exploring data streams.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 315 | 🐛 1,327 | 🌐 Java | 📅 2026-09-15 <sub>![Java][language-java]</sub> - Source-available database purpose-built for stream processing applications.
...
* [Wingfoil](https://github.com/wingfoil-io/wingfoil) ⭐ 220 | 🐛 29 | 🌐 Rust | 📅 2026-09-15 <sub>![Rust/Python/TypeScript][language-rust-python-typescript]</sub> - Graph-based stream processing engine for latency-critical systems.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 97 | 🐛 244 | 🌐 C++ | 📅 2026-09-15 <sub>![C++][language-cpp]</sub> - Data management system for cloud-edge-sensor environments.
...
* [Scramjet Cloud Platform](https://github.com/scramjetorg/transform-hub) ⭐ 71 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-15 <sub>![TypeScript/Python][language-typescript-python]</sub> - Distributed runtime for running and managing data processing programs on edge, server, and cloud infrastructure.
* [LaminarDB](https://github.com/laminardb/laminardb) ⭐ 47 | 🐛 21 | 🌐 Rust | 📅 2026-09-15 <sub>![Rust][language-rust]</sub> - Embeddable streaming SQL engine built on Apache Arrow and DataFusion.
...
* [MediaPipe](https://github.com/google-ai-edge/mediapipe) ⭐ 36,963 | 🐛 537 | 🌐 C++ | 📅 2026-09-15 <sub>![C++/Python/Java/TypeScript][language-cpp-python-java-typescript]</sub> - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 33,730 | 🐛 562 | 🌐 Java | 📅 2026-09-15 <sub>![Java][language-java]</sub> - Stream processing library included with Apache Kafka.
* [Akka](https://github.com/akka/akka-core) ⭐ 13,280 | 🐛 901 | 🌐 Scala | 📅 2026-09-15 <sub>![Scala/Java][language-scala-java]</sub> - Toolkit and runtime for concurrent, distributed, resilient applications on the JVM.
* [Akka Streams](https://github.com/akka/akka-core) ⭐ 13,280 | 🐛 901 | 🌐 Scala | 📅 2026-09-15 <sub>![Scala/Java][language-scala-java]</sub> - Reactive Streams implementation built on Akka actors.
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,664 | 🐛 3,951 | 🌐 Java | 📅 2026-09-15 <sub>![Java/Python/Go][language-java-python-go]</sub> - Unified programming model and language-specific SDKs for batch and streaming data processing.
...
* [River](https://github.com/online-ml/river) ⭐ 6,096 | 🐛 75 | 🌐 Python | 📅 2026-09-14 <sub>![Python][language-python]</sub> - Online machine learning library for Python.
* [FastStream](https://github.com/ag2ai/faststream) ⭐ 5,341 | 🐛 109 | 🌐 Python | 📅 2026-09-14 <sub>![Python][language-python]</sub> - Asynchronous framework for building event-driven applications with Kafka, RabbitMQ, NATS, Redis, and MQTT.
* [FS2](https://github.com/typelevel/fs2) ⭐ 2,453 | 🐛 138 | 🌐 Scala | 📅 2026-09-14 <sub>![Scala][language-scala]</sub> - Compositional streaming I/O library for Scala.
...
* [Monix](https://github.com/monix/monix) ⭐ 1,928 | 🐛 87 | 🌐 Scala | 📅 2026-09-14 <sub>![Scala][language-scala]</sub> - High-performance Scala and Scala.js library for asynchronous and event-based programs.
...
* [Apache Pekko](https://github.com/apache/pekko) ⭐ 1,640 | 🐛 166 | 🌐 Scala | 📅 2026-09-14 <sub>![Scala/Java][language-scala-java]</sub> - Open-source toolkit for concurrent, distributed, resilient applications, forked from Akka 2.6.
* [Quix Streams](https://github.com/quixio/quix-streams) ⭐ 1,572 | 🐛 31 | 🌐 Python | 📅 2026-09-15 <sub>![Python][language-python]</sub> - Python framework for real-time data engineering, analytics, and machine learning on Apache Kafka.
...
* [Apache StormCrawler](https://github.com/apache/stormcrawler) ⭐ 995 | 🐛 41 | 🌐 Java | 📅 2026-09-15 <sub>![Java][language-java]</sub> - Scalable web crawler SDK based on Apache Storm.
* [DataSketches](https://github.com/apache/datasketches-java) ⭐ 959 | 🐛 10 | 🌐 Java | 📅 2026-09-13 <sub>![Java][language-java]</sub> - Apache library of stochastic streaming algorithms known as sketches.
...
* [Streamiz.Kafka.Net](https://github.com/LGouellec/streamiz) ⭐ 544 | 🐛 33 | 🌐 C# | 📅 2026-09-09 <sub>![C#][language-csharp]</sub> - .NET stream processing library for Apache Kafka.
...
* [CapyMOA](https://github.com/adaptive-machine-learning/CapyMOA) ⭐ 146 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-09-15 <sub>![Python/Java][language-python-java]</sub> - Machine learning library for data streams with a Python API and MOA backend.
...
* [Kzmlabs StateFun Actors](https://github.com/kzmlabs/flink-statefun) ⭐ 13 | 🐛 21 | 🌐 Java | 📅 2026-08-30 <sub>![Java][language-java]</sub> - Stateful actors on Apache Flink 2.x with durable per-key state, exactly-once messaging, and Kafka and Kinesis I/O.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,284 | 🐛 36 | 🌐 Python | 📅 2026-09-15 <sub>![Python/Rust][language-python-rust]</sub> - Python ETL framework for stream processing, real-time analytics, and AI data pipelines.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,557 | 🐛 85 | 🌐 Rust | 📅 2026-09-14 <sub>![Rust/Python][language-rust-python]</sub> - Incremental data transformation engine for continuously updated AI and agent workloads.
* [Redpanda Connect](https://github.com/redpanda-data/connect) ⭐ 8,754 | 🐛 326 | 🌐 Go | 📅 2026-09-15 <sub>![Go][language-go]</sub> - Declarative stream processor for moving, enriching, transforming, and filtering data between sources and sinks.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,485 | 🐛 49 | 🌐 Go | 📅 2026-09-15 <sub>![Go][language-go]</sub> - Developer-focused customer data platform for event streaming and cloud-to-warehouse data pipelines.
* [inGestr](https://github.com/bruin-data/ingestr) ⭐ 3,964 | 🐛 21 | 🌐 Go | 📅 2026-09-15 <sub>![Go/Python][language-go-python]</sub> - Command-line application and Python SDK for copying data between databases, SaaS applications, and data warehouses.
* [Databus](https://github.com/linkedin/databus) ⭐ 3,682 | 🐛 41 | 🌐 Java | 📅 2023-09-28 <sub>![Archived][archived-badge]</sub> <sub>![Java][language-java]</sub> - LinkedIn source-agnostic distributed change data capture system.
* [Apache Flume](https://github.com/apache/logging-flume) ⭐ 2,570 | 🐛 82 | 🌐 Java | 📅 2026-09-11 <sub>![Java][language-java]</sub> - Distributed service for collecting, aggregating, and moving large amounts of log-like data.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,708 | 🐛 58 | 🌐 Go | 📅 2026-09-14 <sub>![Go][language-go]</sub> - End-to-end data pipeline tool combining ingestion, SQL and Python transformations, and data quality checks.
* [Brooklin](https://github.com/linkedin/Brooklin) ⭐ 967 | 🐛 36 | 🌐 Java | 📅 2026-08-19 <sub>![Java][language-java]</sub> - Distributed system for reliable nearline data streaming between heterogeneous systems at scale.
...
* [faucet-stream](https://github.com/faucet-hq/faucet-stream) ⭐ 11 | 🐛 52 | 🌐 Rust | 📅 2026-09-15 <sub>![Rust][language-rust]</sub> - Config-driven platform and embeddable library for ETL, CDC, and streaming data movement.
...
* [StreamAlert](https://github.com/airbnb/streamalert) ⭐ 2,890 | 🐛 90 | 🌐 Python | 📅 2023-10-23 <sub>![Archived][archived-badge]</sub> <sub>![Python][language-python]</sub> - Airbnb serverless framework for real-time security log analysis and alerting.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,727 | 🐛 254 | 🌐 Java | 📅 2026-09-14 <sub>![Java][language-java]</sub> - Multi-protocol gateway for connecting applications, APIs, agents, and devices to event streams.
...
* [Nussknacker](https://github.com/TouK/nussknacker) ⭐ 744 | 🐛 51 | 🌐 Scala | 📅 2026-09-11 <sub>![Scala][language-scala]</sub> - Visual tool for defining and running real-time decision algorithms.
...
* [Substation](https://github.com/brexhq/substation) ⭐ 406 | 🐛 3 | 🌐 Go | 📅 2026-01-20 <sub>![Go][language-go]</sub> - Toolkit for routing, normalizing, and enriching security event and audit logs.
...
* [Eventum](https://github.com/eventum-generator/eventum) ⭐ 65 | 🐛 4 | 🌐 Python | 📅 2026-09-08 <sub>![Python/TypeScript][language-python-typescript]</sub> - Data generation platform for producing synthetic event streams.
...
* [streaming-benchmarks](https://github.com/yahoo/streaming-benchmarks) ⭐ 649 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2023-12-17 <sub>![Archived][archived-badge]</sub> <sub>![Java][language-java]</sub> - Benchmarks for low-latency stream processing systems including Storm, Spark, and Flink.
