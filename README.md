...
## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,194 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 3,013 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-07

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 504,194 | 🐛 106 | 📅 2026-09-02.
...
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 43,957 | 🐛 524 | 🌐 Scala | 📅 2026-09-08 <sub>![Scala/Java/Python/R][language-scala-java-python-r]</sub> - Scalable, fault-tolerant stream processing on Apache Spark.
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 33,691 | 🐛 565 | 🌐 Java | 📅 2026-09-08 <sub>![Java/Scala][language-java-scala]</sub> - Distributed event streaming platform for high-performance data pipelines and applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,322 | 🐛 374 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Distributed engine for stateful computation over bounded and unbounded data streams.
...
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,583 | 🐛 640 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Cloud-native messaging and streaming platform for event-driven applications.
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,326 | 🐛 1,759 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Distributed pub-sub messaging and event streaming platform.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 12,525 | 🐛 532 | 🌐 C++ | 📅 2026-08-22 <sub>![C++][language-cpp]</sub> - Kafka API-compatible streaming data platform without ZooKeeper or a JVM.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 10,660 | 🐛 61 | 🌐 Java | 📅 2026-09-08 <sub>![Java/Scala][language-java-scala]</sub> - Diskless Kafka-compatible streaming platform that stores durable data in object storage.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 9,305 | 🐛 1,640 | 🌐 Rust | 📅 2026-09-08 <sub>![Rust][language-rust]</sub> - PostgreSQL-compatible streaming database for event-driven applications, real-time ETL, and continuous analytics.
* [Aeron](https://github.com/aeron-io/aeron) ⭐ 8,848 | 🐛 23 | 🌐 Java | 📅 2026-09-08 <sub>![Java/C++][language-java-cpp]</sub> - Reliable UDP unicast, multicast, and IPC message transport.
* [Apache Storm](https://github.com/apache/storm) ⭐ 6,695 | 🐛 33 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Distributed real-time computation system for reliably processing unbounded streams of data.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,829 | 🐛 281 | 🌐 Rust | 📅 2026-09-08 <sub>![Rust/Go/TypeScript][language-rust-go-typescript]</sub> - Kubernetes-native, language-agnostic platform for scalable event-driven applications.
...
* [Proton](https://github.com/timeplus-io/proton) ⭐ 2,253 | 🐛 81 | 🌐 C++ | 📅 2026-09-02 <sub>![C++][language-cpp]</sub> - Unified streaming and historical data analytics database powered by ClickHouse.
...
* [eKuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,732 | 🐛 49 | 🌐 Go | 📅 2026-09-08 <sub>![Go][language-go]</sub> - Lightweight data stream processing engine for resource-constrained IoT edge devices.
...
* [Gazette](https://github.com/gazette/core) ⭐ 797 | 🐛 21 | 🌐 Go | 📅 2026-09-02 <sub>![Go][language-go]</sub> - Cloud-storage-backed streaming infrastructure that combines SQL, batch, and millisecond-latency stream processing.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 795 | 🐛 59 | 🌐 Go | 📅 2026-09-08 <sub>![Go/Python][language-go-python]</sub> - Stream processing engine that runs DuckDB SQL over Kafka, WebSocket, and webhook streams.
* [Gearpump](https://github.com/gearpump/gearpump) ⭐ 755 | 🐛 3 | 🌐 Scala | 📅 2026-09-08 <sub>![Scala][language-scala]</sub> - Lightweight real-time distributed streaming engine built on Akka.
* [Apache StreamPipes](https://github.com/apache/streampipes) ⭐ 745 | 🐛 62 | 🌐 Java | 📅 2026-09-08 <sub>![Java/Python/TypeScript][language-java-python-typescript]</sub> - Self-service industrial IoT platform for connecting, analyzing, and exploring data streams.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 315 | 🐛 1,330 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Source-available database purpose-built for stream processing applications.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 96 | 🐛 247 | 🌐 C++ | 📅 2026-09-08 <sub>![C++][language-cpp]</sub> - Data management system for cloud-edge-sensor environments.
...
* [Scramjet Cloud Platform](https://github.com/scramjetorg/transform-hub) ⭐ 71 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-08 <sub>![TypeScript/Python][language-typescript-python]</sub> - Distributed runtime for running and managing data processing programs on edge, server, and cloud infrastructure.
* [LaminarDB](https://github.com/laminardb/laminardb) ⭐ 46 | 🐛 25 | 🌐 Rust | 📅 2026-09-08 <sub>![Rust][language-rust]</sub> - Embeddable streaming SQL engine built on Apache Arrow and DataFusion.
...
* [MediaPipe](https://github.com/google-ai-edge/mediapipe) ⭐ 36,881 | 🐛 547 | 🌐 C++ | 📅 2026-09-08 <sub>![C++/Python/Java/TypeScript][language-cpp-python-java-typescript]</sub> - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 33,691 | 🐛 565 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Stream processing library included with Apache Kafka.
* [Akka](https://github.com/akka/akka-core) ⭐ 13,279 | 🐛 901 | 🌐 Scala | 📅 2026-09-08 <sub>![Scala/Java][language-scala-java]</sub> - Toolkit and runtime for concurrent, distributed, resilient applications on the JVM.
* [Akka Streams](https://github.com/akka/akka-core) ⭐ 13,279 | 🐛 901 | 🌐 Scala | 📅 2026-09-08 <sub>![Scala/Java][language-scala-java]</sub> - Reactive Streams implementation built on Akka actors.
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,658 | 🐛 3,973 | 🌐 Java | 📅 2026-09-08 <sub>![Java/Python/Go][language-java-python-go]</sub> - Unified programming model and language-specific SDKs for batch and streaming data processing.
...
* [FastStream](https://github.com/ag2ai/faststream) ⭐ 5,332 | 🐛 104 | 🌐 Python | 📅 2026-09-08 <sub>![Python][language-python]</sub> - Asynchronous framework for building event-driven applications with Kafka, RabbitMQ, NATS, Redis, and MQTT.
...
* [Monix](https://github.com/monix/monix) ⭐ 1,928 | 🐛 87 | 🌐 Scala | 📅 2026-09-07 <sub>![Scala][language-scala]</sub> - High-performance Scala and Scala.js library for asynchronous and event-based programs.
...
* [Apache Pekko](https://github.com/apache/pekko) ⭐ 1,635 | 🐛 163 | 🌐 Scala | 📅 2026-09-08 <sub>![Scala/Java][language-scala-java]</sub> - Open-source toolkit for concurrent, distributed, resilient applications, forked from Akka 2.6.
* [Quix Streams](https://github.com/quixio/quix-streams) ⭐ 1,570 | 🐛 31 | 🌐 Python | 📅 2026-09-08 <sub>![Python][language-python]</sub> - Python framework for real-time data engineering, analytics, and machine learning on Apache Kafka.
...
* [Apache StormCrawler](https://github.com/apache/stormcrawler) ⭐ 995 | 🐛 67 | 🌐 Java | 📅 2026-09-07 <sub>![Java][language-java]</sub> - Scalable web crawler SDK based on Apache Storm.
* [DataSketches](https://github.com/apache/datasketches-java) ⭐ 959 | 🐛 11 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Apache library of stochastic streaming algorithms known as sketches.
...
* [CapyMOA](https://github.com/adaptive-machine-learning/CapyMOA) ⭐ 144 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-07 <sub>![Python/Java][language-python-java]</sub> - Machine learning library for data streams with a Python API and MOA backend.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,321 | 🐛 35 | 🌐 Python | 📅 2026-09-08 <sub>![Python/Rust][language-python-rust]</sub> - Python ETL framework for stream processing, real-time analytics, and AI data pipelines.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,507 | 🐛 75 | 🌐 Rust | 📅 2026-09-08 <sub>![Rust/Python][language-rust-python]</sub> - Incremental data transformation engine for continuously updated AI and agent workloads.
* [Redpanda Connect](https://github.com/redpanda-data/connect) ⭐ 8,740 | 🐛 336 | 🌐 Go | 📅 2026-09-08 <sub>![Go][language-go]</sub> - Declarative stream processor for moving, enriching, transforming, and filtering data between sources and sinks.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,486 | 🐛 51 | 🌐 Go | 📅 2026-09-08 <sub>![Go][language-go]</sub> - Developer-focused customer data platform for event streaming and cloud-to-warehouse data pipelines.
* [inGestr](https://github.com/bruin-data/ingestr) ⭐ 3,951 | 🐛 21 | 🌐 Go | 📅 2026-09-08 <sub>![Go/Python][language-go-python]</sub> - Command-line application and Python SDK for copying data between databases, SaaS applications, and data warehouses.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,701 | 🐛 61 | 🌐 Go | 📅 2026-09-08 <sub>![Go][language-go]</sub> - End-to-end data pipeline tool combining ingestion, SQL and Python transformations, and data quality checks.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,730 | 🐛 244 | 🌐 Java | 📅 2026-09-08 <sub>![Java][language-java]</sub> - Multi-protocol gateway for connecting applications, APIs, agents, and devices to event streams.
