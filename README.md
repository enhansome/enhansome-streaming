...
## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,103 | 🐛 105 | 📅 2026-08-21 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 3,008 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-25

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 500,103 | 🐛 105 | 📅 2026-08-21.
...
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 43,880 | 🐛 480 | 🌐 Scala | 📅 2026-08-26 <sub>![Scala/Java/Python/R][language-scala-java-python-r]</sub> - Scalable, fault-tolerant stream processing on Apache Spark.
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 33,628 | 🐛 524 | 🌐 Java | 📅 2026-08-26 <sub>![Java/Scala][language-java-scala]</sub> - Distributed event streaming platform for high-performance data pipelines and applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,292 | 🐛 374 | 🌐 Java | 📅 2026-08-26 <sub>![Java][language-java]</sub> - Distributed engine for stateful computation over bounded and unbounded data streams.
...
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,570 | 🐛 563 | 🌐 Java | 📅 2026-08-26 <sub>![Java][language-java]</sub> - Cloud-native messaging and streaming platform for event-driven applications.
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,314 | 🐛 1,748 | 🌐 Java | 📅 2026-08-26 <sub>![Java][language-java]</sub> - Distributed pub-sub messaging and event streaming platform.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 12,484 | 🐛 589 | 🌐 C++ | 📅 2026-08-22 <sub>![C++][language-cpp]</sub> - Kafka API-compatible streaming data platform without ZooKeeper or a JVM.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 10,571 | 🐛 56 | 🌐 Java | 📅 2026-08-26 <sub>![Java/Scala][language-java-scala]</sub> - Diskless Kafka-compatible streaming platform that stores durable data in object storage.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 9,290 | 🐛 1,614 | 🌐 Rust | 📅 2026-08-26 <sub>![Rust][language-rust]</sub> - PostgreSQL-compatible streaming database for event-driven applications, real-time ETL, and continuous analytics.
* [Aeron](https://github.com/aeron-io/aeron) ⭐ 8,818 | 🐛 24 | 🌐 Java | 📅 2026-08-26 <sub>![Java/C++][language-java-cpp]</sub> - Reliable UDP unicast, multicast, and IPC message transport.
* [Apache Storm](https://github.com/apache/storm) ⭐ 6,698 | 🐛 35 | 🌐 Java | 📅 2026-08-25 <sub>![Java][language-java]</sub> - Distributed real-time computation system for reliably processing unbounded streams of data.
* [Fluvio](https://github.com/fluvio-community/fluvio) ⭐ 5,246 | 🐛 140 | 🌐 Rust | 📅 2026-08-25 <sub>![Rust/WASM][language-rust-wasm]</sub> - Composable, stateful data streaming system with programmable in-line computation.
* [Arroyo](https://github.com/ArroyoSystems/arroyo) ⭐ 5,015 | 🐛 121 | 🌐 Rust | 📅 2026-08-20 <sub>![Rust][language-rust]</sub> - Distributed stream processing engine for stateful SQL computations over unbounded data.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,825 | 🐛 284 | 🌐 Rust | 📅 2026-08-26 <sub>![Rust/Go/TypeScript][language-rust-go-typescript]</sub> - Kubernetes-native, language-agnostic platform for scalable event-driven applications.
...
* [ArkFlow](https://github.com/arkflow-rs/arkflow) ⭐ 1,302 | 🐛 31 | 🌐 Rust | 📅 2026-08-16 <sub>![Rust][language-rust]</sub> - High-performance stream processing engine with pluggable sources, processors, and sinks.
...
* [Apache StreamPipes](https://github.com/apache/streampipes) ⭐ 739 | 🐛 63 | 🌐 Java | 📅 2026-08-26 <sub>![Java/Python/TypeScript][language-java-python-typescript]</sub> - Self-service industrial IoT platform for connecting, analyzing, and exploring data streams.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 315 | 🐛 1,330 | 🌐 Java | 📅 2026-08-26 <sub>![Java][language-java]</sub> - Source-available database purpose-built for stream processing applications.
...
* [Wingfoil](https://github.com/wingfoil-io/wingfoil) ⭐ 214 | 🐛 27 | 🌐 Rust | 📅 2026-08-25 <sub>![Rust/Python/TypeScript][language-rust-python-typescript]</sub> - Graph-based stream processing engine for latency-critical systems.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 94 | 🐛 268 | 🌐 C++ | 📅 2026-08-26 <sub>![C++][language-cpp]</sub> - Data management system for cloud-edge-sensor environments.
...
* [LaminarDB](https://github.com/laminardb/laminardb) ⭐ 44 | 🐛 24 | 🌐 Rust | 📅 2026-08-26 <sub>![Rust][language-rust]</sub> - Embeddable streaming SQL engine built on Apache Arrow and DataFusion.
...
* [MediaPipe](https://github.com/google-ai-edge/mediapipe) ⭐ 36,726 | 🐛 551 | 🌐 C++ | 📅 2026-08-25 <sub>![C++/Python/Java/TypeScript][language-cpp-python-java-typescript]</sub> - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 33,628 | 🐛 524 | 🌐 Java | 📅 2026-08-26 <sub>![Java][language-java]</sub> - Stream processing library included with Apache Kafka.
* [Akka](https://github.com/akka/akka-core) ⭐ 13,275 | 🐛 901 | 🌐 Scala | 📅 2026-08-26 <sub>![Scala/Java][language-scala-java]</sub> - Toolkit and runtime for concurrent, distributed, resilient applications on the JVM.
* [Akka Streams](https://github.com/akka/akka-core) ⭐ 13,275 | 🐛 901 | 🌐 Scala | 📅 2026-08-26 <sub>![Scala/Java][language-scala-java]</sub> - Reactive Streams implementation built on Akka actors.
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,649 | 🐛 3,973 | 🌐 Java | 📅 2026-08-26 <sub>![Java/Python/Go][language-java-python-go]</sub> - Unified programming model and language-specific SDKs for batch and streaming data processing.
...
* [FastStream](https://github.com/ag2ai/faststream) ⭐ 5,316 | 🐛 110 | 🌐 Python | 📅 2026-08-24 <sub>![Python][language-python]</sub> - Asynchronous framework for building event-driven applications with Kafka, RabbitMQ, NATS, Redis, and MQTT.
...
* [Apache Pekko](https://github.com/apache/pekko) ⭐ 1,629 | 🐛 168 | 🌐 Scala | 📅 2026-08-25 <sub>![Scala/Java][language-scala-java]</sub> - Open-source toolkit for concurrent, distributed, resilient applications, forked from Akka 2.6.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,382 | 🐛 36 | 🌐 Python | 📅 2026-08-26 <sub>![Python/Rust][language-python-rust]</sub> - Python ETL framework for stream processing, real-time analytics, and AI data pipelines.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,406 | 🐛 75 | 🌐 Rust | 📅 2026-08-24 <sub>![Rust/Python][language-rust-python]</sub> - Incremental data transformation engine for continuously updated AI and agent workloads.
* [Redpanda Connect](https://github.com/redpanda-data/connect) ⭐ 8,736 | 🐛 325 | 🌐 Go | 📅 2026-08-26 <sub>![Go][language-go]</sub> - Declarative stream processor for moving, enriching, transforming, and filtering data between sources and sinks.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,477 | 🐛 50 | 🌐 Go | 📅 2026-08-26 <sub>![Go][language-go]</sub> - Developer-focused customer data platform for event streaming and cloud-to-warehouse data pipelines.
* [inGestr](https://github.com/bruin-data/ingestr) ⭐ 3,862 | 🐛 18 | 🌐 Go | 📅 2026-08-26 <sub>![Go/Python][language-go-python]</sub> - Command-line application and Python SDK for copying data between databases, SaaS applications, and data warehouses.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,678 | 🐛 34 | 🌐 Go | 📅 2026-08-26 <sub>![Go][language-go]</sub> - End-to-end data pipeline tool combining ingestion, SQL and Python transformations, and data quality checks.
...
* [faucet-stream](https://github.com/faucet-hq/faucet-stream) ⭐ 7 | 🐛 38 | 🌐 Rust | 📅 2026-08-26 <sub>![Rust][language-rust]</sub> - Config-driven platform and embeddable library for ETL, CDC, and streaming data movement.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,717 | 🐛 228 | 🌐 Java | 📅 2026-08-26 <sub>![Java][language-java]</sub> - Multi-protocol gateway for connecting applications, APIs, agents, and devices to event streams.
...
* [Nussknacker](https://github.com/TouK/nussknacker) ⭐ 743 | 🐛 51 | 🌐 Scala | 📅 2026-08-25 <sub>![Scala][language-scala]</sub> - Visual tool for defining and running real-time decision algorithms.
