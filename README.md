...
## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,965 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 3,013 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-04

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 502,965 | 🐛 106 | 📅 2026-09-02.
...
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 43,948 | 🐛 495 | 🌐 Scala | 📅 2026-09-04 <sub>![Scala/Java/Python/R][language-scala-java-python-r]</sub> - Scalable, fault-tolerant stream processing on Apache Spark.
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 33,666 | 🐛 536 | 🌐 Java | 📅 2026-09-04 <sub>![Java/Scala][language-java-scala]</sub> - Distributed event streaming platform for high-performance data pipelines and applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,326 | 🐛 377 | 🌐 Java | 📅 2026-09-04 <sub>![Java][language-java]</sub> - Distributed engine for stateful computation over bounded and unbounded data streams.
...
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,582 | 🐛 589 | 🌐 Java | 📅 2026-09-04 <sub>![Java][language-java]</sub> - Cloud-native messaging and streaming platform for event-driven applications.
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,325 | 🐛 1,737 | 🌐 Java | 📅 2026-09-03 <sub>![Java][language-java]</sub> - Distributed pub-sub messaging and event streaming platform.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 12,516 | 🐛 534 | 🌐 C++ | 📅 2026-08-22 <sub>![C++][language-cpp]</sub> - Kafka API-compatible streaming data platform without ZooKeeper or a JVM.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 10,613 | 🐛 60 | 🌐 Java | 📅 2026-09-04 <sub>![Java/Scala][language-java-scala]</sub> - Diskless Kafka-compatible streaming platform that stores durable data in object storage.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 9,301 | 🐛 1,630 | 🌐 Rust | 📅 2026-09-04 <sub>![Rust][language-rust]</sub> - PostgreSQL-compatible streaming database for event-driven applications, real-time ETL, and continuous analytics.
...
* [Arroyo](https://github.com/ArroyoSystems/arroyo) ⭐ 5,026 | 🐛 119 | 🌐 Rust | 📅 2026-09-04 <sub>![Rust][language-rust]</sub> - Distributed stream processing engine for stateful SQL computations over unbounded data.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,828 | 🐛 288 | 🌐 Rust | 📅 2026-09-03 <sub>![Rust/Go/TypeScript][language-rust-go-typescript]</sub> - Kubernetes-native, language-agnostic platform for scalable event-driven applications.
...
* [eKuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,733 | 🐛 53 | 🌐 Go | 📅 2026-09-04 <sub>![Go][language-go]</sub> - Lightweight data stream processing engine for resource-constrained IoT edge devices.
...
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 793 | 🐛 28 | 🌐 Go | 📅 2026-09-04 <sub>![Go/Python][language-go-python]</sub> - Stream processing engine that runs DuckDB SQL over Kafka, WebSocket, and webhook streams.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 315 | 🐛 1,329 | 🌐 Java | 📅 2026-09-04 <sub>![Java][language-java]</sub> - Source-available database purpose-built for stream processing applications.
...
* [Wingfoil](https://github.com/wingfoil-io/wingfoil) ⭐ 217 | 🐛 30 | 🌐 Rust | 📅 2026-09-04 <sub>![Rust/Python/TypeScript][language-rust-python-typescript]</sub> - Graph-based stream processing engine for latency-critical systems.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 95 | 🐛 259 | 🌐 C++ | 📅 2026-09-04 <sub>![C++][language-cpp]</sub> - Data management system for cloud-edge-sensor environments.
...
* [LaminarDB](https://github.com/laminardb/laminardb) ⭐ 45 | 🐛 26 | 🌐 Rust | 📅 2026-09-03 <sub>![Rust][language-rust]</sub> - Embeddable streaming SQL engine built on Apache Arrow and DataFusion.
...
* [MediaPipe](https://github.com/google-ai-edge/mediapipe) ⭐ 36,838 | 🐛 541 | 🌐 C++ | 📅 2026-09-04 <sub>![C++/Python/Java/TypeScript][language-cpp-python-java-typescript]</sub> - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 33,666 | 🐛 536 | 🌐 Java | 📅 2026-09-04 <sub>![Java][language-java]</sub> - Stream processing library included with Apache Kafka.
...
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,658 | 🐛 3,962 | 🌐 Java | 📅 2026-09-04 <sub>![Java/Python/Go][language-java-python-go]</sub> - Unified programming model and language-specific SDKs for batch and streaming data processing.
...
* [River](https://github.com/online-ml/river) ⭐ 6,086 | 🐛 76 | 🌐 Python | 📅 2026-09-03 <sub>![Python][language-python]</sub> - Online machine learning library for Python.
* [FastStream](https://github.com/ag2ai/faststream) ⭐ 5,325 | 🐛 102 | 🌐 Python | 📅 2026-09-04 <sub>![Python][language-python]</sub> - Asynchronous framework for building event-driven applications with Kafka, RabbitMQ, NATS, Redis, and MQTT.
* [FS2](https://github.com/typelevel/fs2) ⭐ 2,452 | 🐛 150 | 🌐 Scala | 📅 2026-09-04 <sub>![Scala][language-scala]</sub> - Compositional streaming I/O library for Scala.
...
* [Apache Pekko](https://github.com/apache/pekko) ⭐ 1,632 | 🐛 169 | 🌐 Scala | 📅 2026-09-04 <sub>![Scala/Java][language-scala-java]</sub> - Open-source toolkit for concurrent, distributed, resilient applications, forked from Akka 2.6.
* [Quix Streams](https://github.com/quixio/quix-streams) ⭐ 1,570 | 🐛 29 | 🌐 Python | 📅 2026-09-04 <sub>![Python][language-python]</sub> - Python framework for real-time data engineering, analytics, and machine learning on Apache Kafka.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,345 | 🐛 35 | 🌐 Python | 📅 2026-09-04 <sub>![Python/Rust][language-python-rust]</sub> - Python ETL framework for stream processing, real-time analytics, and AI data pipelines.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,463 | 🐛 76 | 🌐 Rust | 📅 2026-09-04 <sub>![Rust/Python][language-rust-python]</sub> - Incremental data transformation engine for continuously updated AI and agent workloads.
* [Redpanda Connect](https://github.com/redpanda-data/connect) ⭐ 8,738 | 🐛 338 | 🌐 Go | 📅 2026-09-04 <sub>![Go][language-go]</sub> - Declarative stream processor for moving, enriching, transforming, and filtering data between sources and sinks.
...
* [inGestr](https://github.com/bruin-data/ingestr) ⭐ 3,943 | 🐛 23 | 🌐 Go | 📅 2026-09-04 <sub>![Go/Python][language-go-python]</sub> - Command-line application and Python SDK for copying data between databases, SaaS applications, and data warehouses.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,689 | 🐛 57 | 🌐 Go | 📅 2026-09-04 <sub>![Go][language-go]</sub> - End-to-end data pipeline tool combining ingestion, SQL and Python transformations, and data quality checks.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,732 | 🐛 248 | 🌐 Java | 📅 2026-09-04 <sub>![Java][language-java]</sub> - Multi-protocol gateway for connecting applications, APIs, agents, and devices to event streams.
